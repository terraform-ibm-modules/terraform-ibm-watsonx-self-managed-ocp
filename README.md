...
| <a name="input_cloud_pak_deployer_resources"></a> [cloud\_pak\_deployer\_resources](#input\_cloud\_pak\_deployer\_resources) | Kubernetes resource requests and limits for the Cloud Pak Deployer install job. | <pre>object({<br/>    requests = object({<br/>      cpu    = string<br/>      memory = string<br/>    })<br/>    limits = object({<br/>      cpu    = string<br/>      memory = string<br/>    })<br/>  })</pre> | <pre>{<br/>  "limits": {<br/>    "cpu": "1000m",<br/>    "memory": "2Gi"<br/>  },<br/>  "requests": {<br/>    "cpu": "500m",<br/>    "memory": "1Gi"<br/>  }<br/>}</pre> | no |
