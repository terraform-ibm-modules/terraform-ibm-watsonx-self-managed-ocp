...
<ul>
  ...
  <li><a href="./modules">Submodules</a>
    <ul>
      <li><a href="./modules/cpd-image-build">cpd-image-build</a></li>
    </ul>
  </li>
  ...
  <li><a href="./solutions">Deployable Architectures</a>
    <ul>
      <li><a href="./solutions/fully-configurable">Watsonx (Self-Managed) on Red Hat OpenShift</a></li>
    </ul>
  </li>
...
| <a name="input_odf_version"></a> [odf\_version](#input\_odf\_version) | Version of OpenShift Data Foundation (ODF) add-on to install. Only applies if `install_odf_cluster_addon` is true. | `string` | `"4.20.0"` | no |
